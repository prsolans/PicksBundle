...
namespace PRS\PicksBundle\Controller;
...
use PRS\PicksBundle\Entity\User;
use PRS\PicksBundle\Form\UserType;
use PRS\PicksBundle\Form\UserFilterType;
...
class UserController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('PRSPicksBundle:User')->createQueryBuilder('e');
    ...
    */
     ...
     * @Method("POST")
     * @Template("PRSPicksBundle:User:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PRSPicksBundle:User')->find($id);
     ...
     * @Method("PUT")
     * @Template("PRSPicksBundle:User:edit.html.twig")
     */
